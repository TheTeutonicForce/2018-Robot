#include "AM_C_FarSwitch_Right.h"

AM_C_FarSwitch_Right::AM_C_FarSwitch_Right() {
	// Add Commands here:
	...
	AddSequential(new AutoAccel((125-15)/12,0.3,1,90));
	AddSequential(new AutoTurn((-90+14),0.2,1));
	AddSequential(new Delay(1));
	AddSequential(new AutoAccel((415-15)/12,0.3,1,-90));
